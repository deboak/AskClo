      ...
      <section className="authAside registerAside">
        <div>
          <span className="kicker">
            <span aria-hidden="true">✦</span> Personal styling
          </span>
          <h1>
            Recommendations that fit <em>your life.</em>
          </h1>
      ...
      <section className="authFormWrap">
        <form className="authForm registerForm" onSubmit={submit}>
          ...
          <div className="fieldRow">
            <label>
              First name
              <input name="first_name" required placeholder="Ada" />
            </label>
            <label>
              Last name
              <input name="last_name" required placeholder="Okafor" />
            </label>
          </div>
          <label>
            Email
          ...
          <label>
            Phone number
            <input type="tel" name="phone_number" required placeholder="0801 234 5678" />
          </label>
          <label>
            Password
            <input
